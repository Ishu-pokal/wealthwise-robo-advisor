...
```bash
git clone https://github.com/ishupokal/wealthwise-robo-advisor.git
...
Hi, I am **Isita Pokal**, a Supply Chain Analyst with over 4 years of experience in data-driven optimization and demand planning. I maintain this project to apply institutional-grade optimization frameworks to personal finance management.

**Technical Focus**:
- Full-stack development using Next.js and Python
- Financial modeling and Monte Carlo simulations
- SQL-based data architecture and optimization
- Real-time data visualization with D3.js

**Contact**:
- Email: ishupokal077@gmail.com
- LinkedIn: [linkedin.com/in/isitapokal](https://linkedin.com/in/isitapokal)
- GitHub: [@ishupokal](https://github.com/ishupokal)
